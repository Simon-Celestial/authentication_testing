...
import {RegisterCall} from "../../../services/auth.js";
  ...
  return (
    <section className='bg-gray-900 dark:bg-gray-900'>
      <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0'>
        <Link
          to='/'
          className='flex items-center mb-6 text-2xl font-semibold text-amber-50 dark:text-white'
        >
          <img
        ...
        <div className='w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700'>
          <div className='p-6 space-y-4 md:space-y-6 sm:p-8 bg-gray-700 border-2 border-amber-600'>
